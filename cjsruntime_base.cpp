...
namespace clib {
    ...
    void cjsruntime::init(void *p) {
        ...
        // length
        auto _zero_int = _new_number(1, js_value::at_const | js_value::at_refs);
        ...
        permanents._proto_object_hasOwnProperty->obj.insert({"length", _zero_int});
        ...
        permanents._proto_function_call->obj.insert({"length", _zero_int});
        ...
        permanents._proto_function_apply->obj.insert({"length", _zero_int});
        ...
        permanents._debug_print->obj.insert({"length", _zero_int});
        ...
        permanents._debug_dump->obj.insert({"length", _zero_int});
        ...
        permanents.console_log->obj.insert({"length", _zero_int});
        ...
        permanents.sys_exec_file->obj.insert({"length", _zero_int});
        ...
        permanents.f_number->obj.insert({"length", _zero_int});
        ...
        permanents.f_boolean->obj.insert({"length", _zero_int});
        ...
        permanents.f_object->obj.insert({"length", _zero_int});
        ...
        permanents.f_string->obj.insert({"length", _zero_int});
        ...
        permanents.f_function->obj.insert({"length", _zero_int});
        ...
        permanents.f_array->obj.insert({"length", _zero_int});
        ...
        permanents.global_setTimeout->obj.insert({"length", _zero_int});
        ...
        permanents.global_setTimeout->builtin = [](auto &func, auto &_this, auto &args, auto &js, auto attr) {
            ...
            std::vector<std::weak_ptr<js_value>> new_args;
            return js.call_api(JS_FUN(arg), _this, new_args, 0);
        };
        ...
        permanents.f_error->obj.insert({"length", _zero_int});
        permanents.f_error->name = "Error";
        permanents.f_error->builtin = [](auto &func, auto &_this, auto &args, auto &js, auto attr) {
            auto err = js.new_error();
            if (!args.empty()) {
                err->obj.insert({"message", js.new_string(args.front().lock()->to_string())});
            }
